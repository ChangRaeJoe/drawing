...
const app = http.createServer(function(request, response){
    ...
    */
    ...
    else if(pathname === '/ajax/redu/id')
    {
        create.postAjaxId(request, response, db);
    }
    else if(pathname === '/ajax/redu/nick')
    {
        create.postAjaxNick(request, response,db);
    }
    else if(pathname === '/ajax/redu/email')
    {
        create.postAjaxEmail(request, response,db);
    }
